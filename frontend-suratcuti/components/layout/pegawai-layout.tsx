...
import { LayoutDashboard, PlusCircle, History, KeyRound, LogOut, Menu } from "lucide-react"
...
const navigation = [
  ...
  { name: "Ajukan Cuti", href: "/pegawai/ajukan", icon: PlusCircle },
  { name: "Riwayat Cuti", href: "/pegawai/riwayat", icon: History },
  { name: "Ubah Password", href: "/pegawai/password", icon: KeyRound },
]

export function PegawaiLayout({ children }: { children: React.ReactNode }) {
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white/95 backdrop-blur-lg shadow-2xl">
          <div className="flex h-20 items-center justify-center px-4 border-b border-gray-200 bg-white">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-md font-bold text-gray-800">Portal Pegawai</h1>
